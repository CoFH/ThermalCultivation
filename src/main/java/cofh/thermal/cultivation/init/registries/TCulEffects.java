...
public class TCulEffects {
    ...
    public static final Supplier<MobEffect> FORTUNE_REVEALED = EFFECTS.register(ID_EFFECT_FORTUNE_REVEALED, () -> new NeutralMobEffect(MobEffectCategory.NEUTRAL, 0x888888));
