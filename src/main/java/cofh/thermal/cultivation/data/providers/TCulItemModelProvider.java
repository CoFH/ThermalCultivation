...
public class TCulItemModelProvider extends ItemModelProviderCoFH {
    ...
    public TCulItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
    ...
    protected void registerModels() {
        ...
        // FOODS
        generated(reg.getSup(ID_COOKED_CORN));
        generated(reg.getSup(ID_COOKED_EGGPLANT));
